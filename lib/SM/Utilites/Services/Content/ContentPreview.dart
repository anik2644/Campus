...
class _ContentPreviewState extends State<ContentPreview> {
  ...
  Widget ImageContainer(int i)
  {
    return  Container(
      ...
      child: Image.file(
        File(widget.ContentImageSequence[i]),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(preferredSize:  Size.fromHeight(kToolbarHeight), child: ContentAppBAr()),
      body: Center(
        child: Column(
                           ...
                           index<widget.ContentImageSequence.length ? Container(
                              ...
                              child: Image.file(
                                //File(widget.InputImagesSequence[int.parse(widget.ContentImageSequence[index])])
                                  File(widget.ContentImageSequence[index])
