...
import 'package:social_media_app/SM/screens/view_content.dart';
...
class ContentCard extends StatelessWidget {
  ...
  // Description = post.ContentSegments[0].substring(0, 10);
  ...
  buildTitle(BuildContext context, Content? post) {
